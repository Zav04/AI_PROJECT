...
for file_path in file_paths:
    ...
    caminhoRobot2Product = BFS_search.search(robot_row, robot_col, product_row, product_col,'P') # Procura o caminho do robô até o produto# Procura o caminho do robô até o produto
